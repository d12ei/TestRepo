...
public class BKI63 extends AbstractRecord {
...
//    }
    ...
    private BKI63(boolean readOnly) {
     ...
     */
    public boolean checkCarrier(String CarrierCode) {
        return false;
    }
    ...
    public ResultSet getFlightDate(long itinerarySegmentID) {
        return null;
    }
...
//    }
    ...
    public void setOperatedCarrierBKI63Historic(String CARR, String FTNR, Date FLIGHTDT, String ORAC, String DSTC,
            Long ItinerarySegmentID, int HotfileId) {
    }

    public String fillLeftWithZero(String value, int size) {
        return null;
    }

//    private void updateBKI63(OperatedCarrier op_carrier, Long ItinerarySegmentID) {
//    }
    private void updateLogs(Date FLIGHTDT, int operatedCarrId, String CARR, String FTNR, String operatedCarrier,
            String operated_flightNo, String ORAC, String DSTC, Date discontinue) {
    }
//
//    private ObjOperatedCarrier getNearestDate(List<ObjOperatedCarrier> opCarr, Date flightDate) {
//        return null;
//    }
