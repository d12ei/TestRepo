...
public class TpBot94 implements Serializable {

    private static final long serialVersionUID = 1L;
    private String totalTransCurrencyID;
    private int addBy;
    ...
    public String getTotalTransCurrencyID() {
        return this.totalTransCurrencyID;
    }

    public void setTotalTransCurrencyID(String totalTransCurrencyID) {
        this.totalTransCurrencyID = totalTransCurrencyID;
    }
